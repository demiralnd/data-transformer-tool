        ...
        monthColumns.forEach(monthCol => {
          ...
          if (impressionValue && impressionValue !== '' && impressionValue !== '-') {
            transformedRows.push({
              ...
              'Impression (ad contact)': impressionValue
            });
          }
        });
      }
      ...
      <div className="w-3/4 p-6 overflow-auto">
        <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-lg shadow-sm border">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Transform and analyze your marketing data
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow border p-6">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg flex items-center transition-all duration-200 shadow-md ${
